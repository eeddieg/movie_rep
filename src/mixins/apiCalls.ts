...
export default class ApiCalls extends Vue {
  ...
  static ACTIONS = {
    ...
    GUEST_SESSION: ApiCalls.baseApiUrl + "authentication/guest_session/new?api_key=" + API_KEY,
    MOVIE: ApiCalls.baseApiUrl + "movie/550?api_key=" + API_KEY,
    REQUEST_TOKEN: ApiCalls.baseApiUrl + "authentication/token/new?api_key=" + API_KEY,
    TRENDING: ApiCalls.baseApiUrl + "trending/all/week?api_key=" + API_KEY,
    VALIDATE: ApiCalls.baseApiUrl + "authentication/token/new?api_key=" + API_KEY,
    VALIDATE_WITH_LOGIN: ApiCalls.baseApiUrl + "authentication/token/validate_with_login?api_key=" + API_KEY,
  };
